...
\tikzmath{
  ...
  % TODO: on the left there is too much space
...
\tikzmath{
  ...
  %     { \fill[coarseColor] (\x em,\y em) rectangle (\x+\legendBlockWidth em,\y+\legendBlockHeight em); };
  %     { \node[align=left,text width=\width] at (\x+\legendBlockWidth+\legendBlockHSpace em,\y+\legendBlockHeight/2 em){Coarse sweep}; };
  %     \y = \y-\legendBlockHeight-\legendBlockVSpace;
  %     { \fill[fineColor] (\x em,\y em) rectangle (\x+\legendBlockWidth em,\y+\legendBlockHeight em); };
  %     { \node[align=left,text width=\width] at (\x+\legendBlockWidth+\legendBlockHSpace em,\y+\legendBlockHeight/2 em){Fine sweep}; };
  %     \y = \y-\legendBlockHeight-\legendBlockVSpace;
  ...
  %     { \node[align=left,text width=\width] at (\x+\legendBlockWidth+\legendBlockHSpace em,\y+\legendBlockHeight/2 em){Fine comm}; };
  % };
}
